...
function Main() {
  return (
    <div className=" bg-[#944141] my-2 md:my-20">
      <div className=" grid-cols-1 mx-auto grid lg:grid-cols-2">
      <div className="">
        <img className="" src="fotor-ai-2024082818012.jpg" alt="" />
      </div>
      <div className=" text-black ">
      <h1 className=" mx-40 text-3xl mt-44 mb-10 " style={{fontFamily:'fantasy'}}>
            
            MORE ABOUT KEEN AND ABLE
            </h1> 
            <span className="mx-40 text-2xl" style={{fontFamily:'fantasy'}} >
            Our Story
            </span>
            <div className="mx-40" style={{fontFamily:'fantasy'}}>
            <p className="mt-10">

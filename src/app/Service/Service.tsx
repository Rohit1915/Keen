...
function Service() {
  return (
    <div className="bg-[#cbdcdd] pt-[6rem] md:pt-[6rem] pb-[5rem] lg:pt-40 lg:mt-32 md:mt-20 mt-20" style={{fontFamily:'fantasy'}}>
    <h1 className="text-center text-black text-3xl md:text-4xl">SERV<span className="text-red-600">ICES </span></h1>
